...
class ListGroupAdapter3(group: MutableList<Group>, userId: Int, findNavController: NavController): RecyclerView.Adapter<ListGroupAdapter3.ViewHolder>() {
    ...
    inner class ViewHolder(private val item: ListGroupItemBinding) : RecyclerView.ViewHolder(item.root), View.OnClickListener{
        ...
        override fun onClick(v: View?) {
            ...
            navController.navigate(R.id.action_SecondFragment_to_StudentFragment, bundle)
